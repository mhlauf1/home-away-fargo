...
export type SettingsQueryResult = {
  ...
  embedReachScriptUrl: string | null
  localBusiness: {
    businessName?: string
    businessType?: string
    address?: {
